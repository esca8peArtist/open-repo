...
**Updated**: April 28, 2026 (current session — April-May 2026 Domain Content Maintenance); further updated same session with late April 28 Rules Committee collapse.
...
**Late April 28 development — Rules Committee collapse**: The House Rules Committee scheduled a meeting Monday (April 28) to advance the three-year bill to the floor, but recessed and never returned — a procedural collapse indicating leadership cannot yet lock the votes. More than a dozen Republicans have publicly signaled opposition to the three-year bill on the same Fourth Amendment grounds that killed the five-year and 18-month proposals. Rep. Tim Burchett (R-TN): "They keep coming back with the same stuff." Rep. Ralph Norman (R-SC): "Still no warrants, still no CBDC, still no penalties to amount to anything." Rep. Keith Self (R-TX): "The United States Constitution is NOT a suggestion — the Fourth Amendment is the law of the land." Massie and Boebert introduced the Surveillance Accountability Act as an alternative (warrant requirement + private right of action for Fourth Amendment infringement). The Rules Committee recess with 48 hours remaining before the April 30 deadline means the most likely floor path is now either: (a) a further emergency stopgap by unanimous consent; (b) a last-minute leadership deal with enough defector buy-in to survive; or (c) a brief lapse followed by emergency action. The clean three-year passage scenario has materially weakened since April 27.
...
**Revised most likely outcome**: Brief lapse or further emergency stopgap has become roughly co-equal with three-year passage as the most likely outcome, following the Rules Committee collapse. Emergency extension (5-10 day stopgap) is the path of least resistance. If a brief lapse occurs, NSA will shift surveillance collection toward EO 12333 (no statutory expiration, no congressional involvement) — the civil liberties community's worst-case outcome for the long-term surveillance architecture.
