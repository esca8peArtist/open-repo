...
**Stockbot need**: Infrastructure expansion checkpoint June 15; requires technical implementation work (code, infrastructure config)
**Phase 2 Batch 2 need**: Domain 49 expansion research (3–4 agent-hours, June 3–10); Domain 50 Gist prep (1 agent-hour, July 1)

**Conflict assessment**: LOW. These are different agent types. Stockbot infrastructure work is software engineering / data pipeline agent work. Domain 49 expansion is research and writing. They can run in different sessions without contention. No resource conflict unless a single agent session is being asked to do both simultaneously.

**Resolution**: No reallocation needed. Sequence Domain 49 expansion in resistance-research sessions (June 3–10). Stockbot infrastructure work runs in dedicated stockbot sessions. If a single session budget is available, prioritize Domain 49 expansion over stockbot June 15 prep because: (1) redistricting cascade is time-limited to June primary filing deadlines; (2) stockbot June 15 checkpoint is a go/no-go gate, not a hard-deadline with external consequences if slipped.
...
## Scenario 2: Phase 2 Batch 2 vs. Systems Resilience Phase 5 Wave 1 Author Recruitment

**Conflict type**: Agent session allocation
**Systems Resilience need**: Phase 5 Wave 1 author recruitment execution (June 5 send date, June 15 09:00 UTC go/no-go decision); email verification and response monitoring post-June 5
**Phase 2 Batch 2 need**: Domain 49 expansion (June 3–6)

**Conflict assessment**: MEDIUM (same week, same agent type). Both are active in the June 3–8 window. Both are research/writing work.

**Resolution**: Phase 5 author recruitment (June 5 send) has a fixed calendar date. Domain 49 expansion has a distribution-window urgency but is not calendar-fixed. Sequence:
- **June 3–4**: Finalize Phase 5 Wave 1 author recruitment pre-send verification (already complete per WORKLOG.md)
- **June 4**: Domain 49 expansion begins (parallel if separate agent sessions are available)
- **June 5**: Phase 5 Wave 1 June 5 send date
- **June 5–10**: Domain 49 expansion completes

If agent session budget is limited to one session per day: June 3 = Domain 49 expansion start (resistance-research), June 4 = Phase 5 send prep (systems-resilience), June 5 = Phase 5 sends, June 6–7 = Domain 49 expansion completion. No content is lost; the one-day delay on Domain 49 does not affect redistricting advocacy windows.
