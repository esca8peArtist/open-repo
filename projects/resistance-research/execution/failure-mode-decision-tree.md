...
purpose: "Rapid triage during Phase 1 execution. Use this when something goes wrong and you need the immediate next step, not the full analysis. For full protocols, see phase-1-launch-risk-playbook.md (same directory)."
companion_docs:
...
*Failure Mode Decision Tree — Created May 6, 2026. Placed in execution/ directory May 7, 2026. Companion document: `phase-1-launch-risk-playbook.md` (same directory). Use this for rapid triage; use the playbook for full context on each failure type.*
