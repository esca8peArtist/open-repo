...
## Summary Finding (Lead)

After three consecutive legislative failures across April 15-17, 2026, the House appears positioned to pass a three-year warrantless renewal of FISA Section 702 authority (S. 1318, the Foreign Intelligence Accountability Act) on or before April 30. The procedural rule for floor debate passed 215-210 on April 29 — a vote that required the Speaker to hold the chamber open for more than two hours while flipping Republican holdouts. Leadership would not advance a procedural rule unless final passage was secured. The three-year renewal contains no warrant requirement for U.S. person queries, leaves the commercial data broker loophole intact, and attaches a Central Bank Digital Currency (CBDC) ban as a sweetener to break Freedom Caucus opposition.

If the House passes S. 1318, Section 702 authority will not expire at midnight April 30. Senate passage is still required — but Senate Majority Leader Thune had filed cloture for a companion clean three-year extension, signaling Senate leadership alignment. Presidential signature is expected: Trump had demanded an 18-month or longer extension and dropped his SAVE Act attachment condition before the floor vote.

The civil liberties community's position is that this outcome — three-year warrantless renewal — represents a structural defeat. The next reform window will not open until April 2029, beyond the 2026 and 2028 election cycles. EFF, CDT, and ACLU have indicated they will pursue judicial challenges to the warrantless U.S. person query authority regardless of the legislative outcome.

---

## Section 1: Legislative History — The Four Attempts

### Attempt 1: Five-Year Clean Reauthorization (April 15-17)
Speaker Johnson's primary proposal — a five-year renewal with minimal reforms — failed when 20 House Republicans joined most Democrats. The bipartisan opposition bloc was cross-ideological: Freedom Caucus members opposing on Fourth Amendment grounds (FISA was used against Trump associates in 2016-2017, providing political cover) and moderates seeking constituent accountability for a program with documented abuse history. Roll call: approximately 197-228 against.

### Attempt 2: 18-Month Trump-Preferred Extension (April 17)
Failed the same session. Attracted no additional Democratic votes and insufficient Republican support to overcome the civil liberties bloc. Roll call: also failed.

### Attempt 3: 10-Day Stopgap (April 17-18)
Congress passed a 10-day emergency extension through April 30 by unanimous consent in the House and voice vote in the Senate. Trump signed it on April 18. This was the only vehicle with consensus — delaying, not resolving, the legislative standoff.

### Attempt 4: Foreign Intelligence Accountability Act / S. 1318 (April 24 — present)
Speaker Johnson introduced a revised three-year proposal with the following architecture:

**What the bill contains (confirmed):**
- Three-year extension of Section 702 authority through April 30, 2029
- Monthly Civil Liberties Protection Officer (ODNI) reviews of all FBI U.S. person query justifications
- Attorney-level approval required for all FBI queries using U.S. person query terms (replacing field supervisor approval — a procedural upgrade, not a warrant requirement)
- Expanded GAO audit authority over the program
- Strengthened criminal penalties for FBI employees who misuse Section 702
- Expanded congressional and staff access to FISC proceedings
- CBDC ban attached as an amendment to secure Freedom Caucus votes
- No warrant requirement for U.S. person queries
- Commercial data broker loophole remains open

**What the bill does not contain (civil liberties gap):**
- Warrant requirement for back-end searches of Americans' communications collected incidentally during foreign targeting — the core Fourth Amendment objection
- Restrictions on commercial data broker purchases (the route through which ICE and DHS access location data without a court order)
- Geographic limitations on collection
- Private right of action for Fourth Amendment violations

**Just Security assessment ("Fool's Gold"):** The attorney-level approval requirement is procedurally similar to what FBI already required internally after prior compliance failures. The warrant language in the bill addresses front-end targeting (already prohibited) rather than back-end queries of Americans' communications — the actual civil liberties problem. Eighteen years of "compliance whack-a-mole" (Julian Sanchez's framing) is not addressed by adding more internal review layers.

---

## Section 2: The April 28-29 Procedural Sequence

### April 28 — Rules Committee Collapse
The House Rules Committee scheduled a meeting Monday to advance S. 1318 to the floor. The committee recessed and never returned — a procedural collapse publicly attributed to inadequate vote counts. More than a dozen Republicans had publicly signaled opposition on Fourth Amendment warrant grounds. Representative Tim Burchett (R-TN): "They keep coming back with the same stuff." Representative Ralph Norman (R-SC): "Still no warrants, still no CBDC, still no penalties to amount to anything." Representative Keith Self (R-TX): "The United States Constitution is NOT a suggestion." Representatives Massie and Boebert introduced the Surveillance Accountability Act as an alternative (warrant requirement plus private right of action).

The American Prospect reported April 28 that the FISA bill had "imploded" — characterizing it as a final collapse.

### April 29 — Rules Committee Reversal
Within 24 hours, the House Rules Committee revived the bill in a 9-4 vote, advancing a procedural rule for floor consideration. The overnight reversal indicates leadership made vote-count commitments to previously opposed members that are not fully documented in public reporting. The CBDC ban addition was the publicly identified sweetener; whether additional commitments were made is unknown.

### April 29 — Procedural Rule Floor Vote (215-210)
The House voted 215-210 on the procedural rule opening floor debate — a party-line vote that Speaker Johnson held open for more than two hours while flipping Republican holdouts. In the House, a successful procedural rule vote almost always precedes successful final passage, because leadership does not advance rules without locking final votes first. As of 1:32 PM April 29 (the latest confirmed timestamp in available reporting), the final passage vote was pending "later in the day."
...
- NSA retains ability to continue collection under FISC's classified extension ruling (reported to extend collection authority through 2027 regardless of statutory expiration)
- Technology companies compelled to assist NSA collection can legally challenge their obligation — this is the immediate civil liberties litigation vector
- EO 12333 (no statutory expiration, no congressional involvement) becomes the primary substitute collection authority — the surveillance architecture civil liberties advocates most fear, because it has no FISC oversight whatsoever
- Congressional pressure to pass emergency stopgap within days would be intense given intelligence community public testimony about partner-service sharing reductions during periods of legal uncertainty

---

## Section 4: Cross-Domain Implications

### Domain 1 (Voting Rights) — Election Organizer Surveillance Window

A three-year warrantless renewal means FBI retains authority to query the Section 702 database for U.S. person communications without a warrant through April 2029. This directly affects:

- **Election security organizers**: Civil society groups working on 2026 midterm election protection — voter registration drives, poll monitoring, legal observer networks — communicate with foreign-based partners (international human rights organizations, diaspora communities, academic researchers). Those communications are incidentally collected under Section 702's foreign targeting authority, and the FBI can query the resulting database for U.S. persons without a warrant.
- **Protest organizers**: May Day 2026 and ongoing protest organizing involves communication with foreign-based support organizations. Domain 1 Section 6.2 (election security cross-reference) should be updated to reflect the three-year window of warrantless query authority.
- **Immigrant community organizations**: Section 702's incidental U.S. person collection is used in conjunction with — not instead of — the commercial data broker surveillance documented in surveillance-tracking.md. The two surveillance vectors compound each other.

### Domain 6 (Judicial Independence) — EFF/ACLU Legal Challenge Pipeline

The civil liberties community has explicitly stated it will pursue judicial challenges regardless of the legislative outcome. The most likely challenge vectors:

1. **FISC adversarial proceedings**: Amicus briefs challenging the warrantless U.S. person query authority at the Foreign Intelligence Surveillance Court — the only judicial venue with direct jurisdiction
2. **Fourth Amendment challenge in Article III courts**: Based on Carpenter v. United States (2018) doctrine — the reasonable expectation of privacy analysis could be extended to incidentally collected domestic communications. This challenge has been repeatedly dismissed at lower courts on standing grounds; the civil liberties community is building a case that may survive standing after documented FBI query abuses
3. **Commercial data broker separation**: The commercial data purchase pathway (Venntel/Babel Street/Accurint — documented in surveillance-tracking.md Parts 1-3) operates entirely outside Section 702 and is unaffected by any reauthorization outcome. The Fourth Amendment Is Not For Sale Act, which would close this loophole, has not advanced in either chamber

### Domain 35 (Supreme Court 2026 Term) — Carpenter Doctrine Expansion

EFF's indicated judicial challenge strategy will likely seek to expand Carpenter v. United States (2018) — which held that cell-site location data requires a warrant despite third-party doctrine — to the incidental collection context. This is a long-cycle litigation strategy; a cert petition, if one is ultimately filed, would arrive at the Supreme Court no earlier than OT2027. The civil liberties community's pre-litigation groundwork should be monitored in surveillance-tracking.md for new case filings.

---

## Section 5: Civil Liberties Community Response Framework

**EFF (Electronic Frontier Foundation)**: Called the three-year bill "insufficient" and stated it "does not protect Americans from warrantless surveillance." Pre-committed to judicial challenges. Has documented 18-year compliance failure pattern (2008-2026). Key resource: [EFF Section 702 Deeplinks](https://www.eff.org/deeplinks/2026/04/congress-must-reject-new-insufficient-702-reauthorization-bill)

**ACLU**: "Despite Bipartisan Outcry" framing in prior RISAA (2024) response — expects same framing for 2026 outcome. Filed legal challenges after 2024 RISAA on expanded ECSP definition; 2026 challenge will target the warrantless U.S. person query authority directly.

**Brennan Center**: Maintains the definitive 2026 resource page and will publish a post-outcome legal analysis within 48-72 hours of congressional action. Monitor: [Brennan Center Section 702 2026 Resource Page](https://www.brennancenter.org/our-work/research-reports/section-702-foreign-intelligence-surveillance-act-fisa-2026-resource-page)

**Just Security**: "Fool's Gold" assessment of S. 1318 (April 2026) lays out the analytical case for why attorney-level approval is not a meaningful reform. This is the primary analytical document for the civil liberties position. [Just Security — Fool's Gold](https://www.justsecurity.org/137206/johnson-section-702-warrant/)

**Congressional Progressive Caucus**: 98 House Democrats signed the CPC letter opposing reauthorization without warrant protection. These members will vote no on final passage. Their votes, combined with the Freedom Caucus holdouts who did not flip, constitute the bipartisan reform bloc that will continue to push for warrant requirements when the 2029 deadline approaches.

**Bipartisan reform coalition for 2029**: Lofgren-Davidson-Wyden-Lee (House Democrats and Republicans + Senate Democrat and libertarian-leaning Republican) introduced the Government Surveillance Reform Act as the reform alternative. This coalition will be the nucleus of the next reauthorization fight. [Lofgren press release](https://lofgren.house.gov/media/press-releases/lofgren-davidson-wyden-and-lee-introduce-bipartisan-fisa-reform-bill-protect)

---

## Section 6: The Unaddressed Structural Problem — Commercial Data Broker Loophole

This is the surveillance accountability gap that no 2026 proposal closes and that determines the practical surveillance capacity of ICE, DHS, and the FBI regardless of Section 702 outcome:

**The parallel surveillance architecture**: Intelligence agencies and federal law enforcement are currently permitted to purchase location data from commercial data brokers — Venntel/Gravy Analytics, Babel Street, Accurint (LexisNexis) — without a warrant, even when a warrant would be required to compel the same data directly. This is the warrant-end-run documented in surveillance-tracking.md Part 2.

**Why Section 702 reauthorization does not address this**: Section 702 governs foreign-targeted communications collection that incidentally captures U.S. person communications. The commercial data broker pathway operates entirely outside this framework — it involves domestic commercial data purchased by agencies from private companies, not foreign-targeted collection. A warrant requirement amendment to Section 702 would have addressed back-end queries of the 702 database; it would not have touched the commercial data broker pathway.

**Statutory gap**: The Fourth Amendment Is Not For Sale Act (Wyden-Davidson) would close the commercial data broker loophole. It has not advanced in either chamber in the 119th Congress. Senator Wyden sent a March 3, 2026 letter to the DHS OIG demanding investigation into whether ICE continues purchasing location data in violation of the FTC's Venntel/Gravy Analytics order (January 2025). That investigation is pending.

**Practical consequence for 2026-2029**: If S. 1318 passes as described, the surveillance architecture affecting immigrant communities, protest organizers, and civil society groups will consist of:
1. Section 702 warrantless U.S. person query authority — extended through April 2029, no new restrictions
2. Commercial data broker location data purchases — completely unaffected, no new restrictions, Venntel FTC enforcement gap still open
3. Palantir ImmigrationOS ($30M ICE contract, through September 2027) — integrating IRS, SSA, license plate reader, and passport data
4. Clearview AI facial recognition (ICE $9.2M contract, CBP $225K contract) — no restrictions
5. ICE "Ad Tech and Big Data" RFI (January 2026) — next surveillance frontier, completely unaddressed

The combined architecture means the Section 702 outcome — whether warrantless renewal or warrant-protected renewal — addresses only one lane of a five-lane surveillance highway. This is the core civil liberties community message for the 2026-2029 period.
...
- Monitor Senate vote timing and count (Thune cloture + vote expected within 48-72 hours of House passage)
- Monitor for EFF/ACLU post-passage litigation announcement
- If SAVE Act was not included (confirmed): Democratic civil liberties organizations should publicize SAVE Act separation — the voter ID bill did not pass on the FISA vehicle, which was Trump's stated condition for signature

**Short-term (May-June 2026):**
- Demand DHS OIG Wyden investigation results on Venntel FTC order compliance
- Push Fourth Amendment Is Not For Sale Act as the live legislative vehicle — the only bill that would close the commercial data broker loophole
- Document FBI U.S. person query patterns using GAO audit authority now expanded in S. 1318 — this is a transparency accountability lever even in the no-warrant scenario

**2026 Midterm cycle:**
- The bipartisan reform coalition (Lofgren-Davidson-Wyden-Lee + Freedom Caucus members who voted no) is the most important surveillance reform political alliance. Document their positions and signal that the 2029 deadline will bring another reauthorization fight. Elections matter for surveillance reform because Freedom Caucus members who voted on Fourth Amendment grounds can be distinguished from pro-surveillance Republicans.
...
- [The Hill: House Rules Committee advances FISA Section 702, farm bill, ICE funding (April 29)](https://thehill.com/homenews/house/5853444-house-rules-fisa-farm-bill-dhs/)
- [The Hill: House GOP clears key hurdle for FISA, ICE funding in dramatic vote (April 29)](https://thehill.com/homenews/house/5854744-rule-vote-fisa-farm-bill-dhs-2/)
- [CBS News: Renewal of FISA surveillance program in limbo ahead of Thursday deadline (April 29, 1:32 PM)](https://www.cbsnews.com/news/renewal-fisa-section-702-surveillance-program-house-vote-thursday-deadline/)
- [Fox News: Mike Johnson faces revolt from GOP privacy hawks as FISA renewal deadline looms (April 29)](https://www.foxnews.com/politics/mike-johnson-faces-revolt-from-gop-privacy-hawks-threatening-kill-fisa-renewal-deadline-looms)
- [KFGO: US House backs effort to advance measure opening debate on ICE funding and FISA (April 29)](https://kfgo.com/2026/04/29/us-house-backs-effort-to-advance-measure-opening-debate-on-ice-funding-and-fisa/)
- [The American Prospect: As FISA Bill Implodes, Himes Boosted Version He Called 'Unacceptable' (April 28)](https://prospect.org/2026/04/28/implausible-deniability-fisa-section-702-congress-himes/)
- [The Hill: House Republicans tee up vote on spy powers under FISA Section 702 (April 28)](https://thehill.com/homenews/house/5852133-fisa-702-spy-powers-vote/)
- [The Hill: New FISA proposal falls short of privacy advocates' demands (April 28)](https://thehill.com/homenews/house/5845084-fisa-section-702-spy-powers-warrants-house-republicans/)
- [Yahoo/The Hill: Lawmakers head into "hell week" with FISA and reconciliation (April 28)](https://www.yahoo.com/news/articles/week-hill-lawmakers-head-hell-100000076.html)
- [Just Security: Fool's Gold — Speaker Johnson's Section 702 proposal (April 2026)](https://www.justsecurity.org/137206/johnson-section-702-warrant/)
- [EFF: Congress Must Reject New Insufficient 702 Reauthorization Bill (April 2026)](https://www.eff.org/deeplinks/2026/04/congress-must-reject-new-insufficient-702-reauthorization-bill)
- [Nextgov/FCW: House readies vote to renew FISA 702 without a warrant amendment (April 2026)](https://www.nextgov.com/policy/2026/04/house-readies-vote-renew-fisa-702-without-warrant-amendment/412856/)
- [NPR: After 2 failed votes, Mike Johnson unveils new plan to extend key U.S. spy powers (April 24)](https://www.npr.org/2026/04/24/nx-s1-5797964/after-2-failed-votes-mike-johnson-unveils-new-plan-to-extend-key-u-s-spy-powers)
- [NPR: Congress extends controversial surveillance powers for 10 days (April 17)](https://www.npr.org/2026/04/17/nx-s1-5788573/house-extends-surveillance-powers-for-10-days)
...
- [Lofgren press release: Bipartisan FISA Reform Bill (Government Surveillance Reform Act)](https://lofgren.house.gov/media/press-releases/lofgren-davidson-wyden-and-lee-introduce-bipartisan-fisa-reform-bill-protect)
- [Brookings: A key intelligence law expires in April (2026)](https://www.brookings.edu/articles/a-key-intelligence-law-expires-in-april-and-the-path-for-reauthorization-is-unclear/)
- [House Rules Committee: S.1318 text](https://rules.house.gov/bill/119/s-1318)
...
**Lead finding**: Section 702 authority expires June 12, 2026 — approximately 3-4 weeks from this writing. The 45-day extension achieved by the civil liberties blocking coalition represents a structural victory (no three-year warrantless lock-in) but not a reform win. The June 12 deadline is the next decision point, and the dynamics have shifted compared to April: the reform coalition's blocking power is demonstrated, the FISC opinion declassification precedent is established, and the intelligence community's urgency for a long-term resolution has increased — while the reform coalition's minimum demand (warrant requirement) remains unmet.

**Current status and the warrant requirement fault line**

The 45-day extension signed April 30 locked in a clean extension through June 12 with no CBDC ban, no warrant requirement, and no closure of the commercial data broker loophole. The Wyden-Cotton-Warner FISC opinion declassification deal — requiring release of the March 17, 2026 FISC opinion within 15 days of enactment — is the one transparency gain. If that opinion documents significant compliance failures or novel legal authority claims, its public release could shift the political environment for the June fight.

The structural fault line remains: the intelligence community (supported by senior congressional leadership in both parties) insists a warrant requirement for U.S.-person query results would "inhibit efficacy of FISA tool and endanger national security." The civil liberties coalition (EFF, CDT, ACLU, Brennan Center, Wyden-Lee-Lofgren-Davidson bipartisan bloc) insists warrantless backdoor searches of Americans' communications are unconstitutional under Carpenter v. United States (2018) and the Fourth Amendment's original application to content. The definitional dispute — what constitutes a "query" (automated algorithmic search vs. targeted review) — remains unresolved by the Bipartisan Government Surveillance Reform Act as introduced.

The long-term House proposal (3-year extension, 235-191) is effectively dead in the Senate, because the CBDC rider that passed the House cannot reach 60 Senate votes and the Senate's unanimous rejection of the rider establishes a procedural norm against using FISA vehicles for unrelated policy riders. The most likely June 12 outcomes in order of probability: (a) another short-term extension if the warrant impasse holds, (b) a longer extension with a narrow warrant carve-out covering political opposition, journalists, and election officials (the categories where documented administration targeting creates Republican political liability), (c) lapse followed by emergency extension.

**Institutional lock-in risk**

Repeated short-term extensions are creating "ongoing uncertainty for communications providers" regarding compliance obligations (Wiley LLP assessment) and normalizing warrantless query authority as the legislative default. Each extension without a warrant requirement is a ratchet: the baseline from which negotiation starts is warrantless authority, and the reform coalition must fight to add a warrant requirement rather than the government defending an existing warrant requirement. The asymmetry of the negotiating baseline is the primary structural obstacle. If the June 12 deadline produces a one-year or two-year extension without a warrant requirement, the next reform window is 2027-2028 — beyond the 2026 midterm cycle that creates the best political leverage for reform.

**Movement contacts**

- **Electronic Frontier Foundation (EFF)** — Filed the most detailed public legal challenges to the warrantless U.S.-person query authority; committed to FOIA requests for FBI U.S.-person query justifications under the new monthly ODNI CLPO reporting requirement; tracks the active judicial challenge pipeline (U.S. v. Hasbajrami, Second Circuit). Contact for surveillance accountability advocacy, coalition coordination for the June 12 deadline, and technical documentation of algorithmic query definitions. [eff.org](https://www.eff.org/deeplinks/2026/04/congress-must-reject-new-insufficient-702-reauthorization-bill)
- **Center for Democracy and Technology (CDT)** — Maintains the most detailed policy analysis of the commercial data broker loophole (the route through which ICE and DHS access location data without a court order); participated in all April 2026 congressional negotiations; coordinates the civil liberties coalition's technical position on automated query definitions. Contact for policy analysis, congressional staff education, and coalition coordination.
- **Senate Judiciary Committee minority staff (Wyden, Lee offices)** — The operative legislative vehicle is the Bipartisan Government Surveillance Reform Act (Wyden-Davidson-Lee-Lofgren). Senate minority staff have managed the blocking coalition's strategy across five months of FISA negotiations. Contact via Senate offices for legislative strategy coordination, amendment drafting support, and vote-count tracking.

**Policy windows**

- **June 12 deadline** (3-4 weeks): The blocking coalition must hold together through the deadline. If intelligence community pressure causes defections — particularly from moderate Democrats who supported the 45-day extension as a tactical retreat — the three-year warrantless renewal rejected in April could re-emerge as the path of least resistance. The coalition's leverage is maximum at the deadline, not before it.
- **FISC opinion release** (within 15 days of April 30 enactment, approximately mid-May 2026): The declassified FISC opinion may already have been delivered to Congress by the date of this update. If its public release documents compliance failures or novel legal authority claims, the release window (mid-May through June 12) is the optimal period for advocacy organizations to amplify the findings and shift the political environment before the deadline.
- **Judicial challenge track** (ongoing, independent of legislation): U.S. v. Hasbajrami (Second Circuit) is the most advanced judicial vehicle for a warrant requirement ruling. EFF and ACLU have pre-committed to judicial challenges regardless of the June 12 legislative outcome. Monitoring and supporting this litigation track is a parallel advocacy priority — a court ruling requiring warrants for U.S.-person queries would resolve the legislative impasse without congressional action, though on an uncertain timeline.

**Advocacy levers**

- **Congressional pressure on the warrant carve-out** (minority leverage): The Wyden-Davidson-Lee-Lofgren bipartisan bloc demonstrated blocking power in April. The civil liberties community's most effective near-term lever is maintaining coalition unity through June 12. The specific ask for the June negotiation: a warrant carve-out for the categories where the Trump administration has documented targeting — political opposition, journalists, and election officials — that creates Republican political liability sufficient to move 5-8 additional Republican votes. This is a narrower ask than a general warrant requirement and more likely to achieve the 60-vote cloture threshold.
- **Public commentary and transparency advocacy**: If the FISC opinion documents compliance failures, coordinated op-ed placement (EFF, ACLU, Brennan Center, CDT) in the same publication week as the opinion's release maximizes public attention before the June 12 deadline. The May 2026 period is optimal for this sequencing.
- **Coalition coordination with ICE surveillance track**: The commercial data broker loophole documented in this domain (Section 3 of the full domain file) is the mechanism through which ICE and DHS access location data without a court order. Domain 39 (Immigration Enforcement/Detention Infrastructure) and Domain 37 (Federal Executive Interference in 2026 Midterms) document the electoral intimidation dimension of this data access. FISA advocacy that connects the surveillance loophole to documented ICE misuse of location data builds a broader coalition beyond the traditional civil liberties community and creates cross-domain pressure that has not been previously mobilized.

**Cross-references**: Domain 38a (FISA/Intel Oversight Reform — broader surveillance accountability architecture); Domain 39 (Immigration Enforcement/Detention — ICE location data purchasing, commercial data broker mechanism); Domain 37 (Federal Executive Interference in 2026 Midterms — ICE enforcement as electoral intimidation); Domain 35 (SCOTUS 2026 Term — EFF/ACLU judicial challenge pipeline, Hasbajrami vehicle).

Sources: [EFF: 45-day FISA extension — temporary reprieve requiring continued advocacy (April 30, 2026)](https://www.eff.org/deeplinks/2026/04/keep-pushing-we-get-10-more-days-reform-section-702); [Brennan Center: Section 702 2026 Resource Page](https://www.brennancenter.org/our-work/research-reports/section-702-foreign-intelligence-surveillance-act-fisa-2026-resource-page); [Security Boulevard: Congress Punts FISA Section 702 Renewal to June (May 2026)](https://securityboulevard.com/2026/05/congress-punts-fisa-section-702-renewal-to-june/); [American Prospect: Warrant requirement definitional dispute — automated query analysis (May 11, 2026)](https://prospect.org/2026/05/11/fisa-702-warrant-query-definition-automated/); [Just Security: Fool's Gold — Speaker Johnson's Section 702 proposal](https://www.justsecurity.org/137206/johnson-section-702-warrant/)
