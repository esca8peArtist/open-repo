---
title: "Domain 51 — Send Templates (California Campaign Contacts)"
created: "2026-06-02"
status: "production-ready"
gist_url: "https://gist.github.com/esca8peArtist/6dce895c5192e6a3ba2abfed40733372"
hard_deadline: "July 1, 2026 — California Fair Elections Act campaign integration"
secondary_deadline: "June 19, 2026 — Montana I-194 county signature deadline"
send_window: "June 9-30, 2026 (prep this week; send after June 9 when Tier 1 June 2026 sends are complete)"
---

# Domain 51 — Email Send Templates
## California Campaign Contacts + National Policy Organizations
## July 1 Deadline — California Fair Elections Act

All templates are copy-paste ready. Fill `[YOUR_NAME]` and `[YOUR_CONTACT_INFO]` before sending.

Gist URL for all emails: https://gist.github.com/esca8peArtist/6dce895c5192e6a3ba2abfed40733372

**Note on verified contacts**: Email addresses below are drawn from public organization websites as of June 2, 2026. Verify before sending — organization contacts change. Verification notes in domain-51-send-log.md (to be created before send date).
...
Dear Common Cause California team,
...
The research is 58 citations, CC Attribution 4.0. It is designed to be used — excerpted in voter guides, cited in public education materials, shared with your member network:
https://gist.github.com/esca8peArtist/6dce895c5192e6a3ba2abfed40733372
...
CC Attribution 4.0 — use it, adapt it, share it with your campaign legal team and communications staff:
https://gist.github.com/esca8peArtist/6dce895c5192e6a3ba2abfed40733372
...
## Email 5 — Issue One (National — ReFormers Caucus)

**To**: info@issueone.org (verify at issueone.org/contact)
...
**June 9-10, 2026 — Research/legal organizations (Monday-Tuesday)**
1. Campaign Legal Center — longest decision cycle; benefits from most lead time
2. Issue One — national advocacy org; sends to national first, California second

**June 11-12, 2026 — California campaign contacts (Wednesday-Thursday)**
3. Common Cause California — primary California ballot campaign contact
4. League of Women Voters California — voter education primary
5. Clean Money Action Fund — campaign-specific organization

### Rationale

Legal/research organizations (CLC, Issue One) are sent first because:
- Their buy-in signals research quality to California campaign contacts
- They have the longest review cycles before responding
- CLC's constitutional analysis of Hawaii SB 2471 is the most technically demanding framing — send when their staff has attention

California campaign contacts are sent mid-week when campaign staff email attention is highest (Tuesday-Thursday 09:00-14:00 local time).

**Hard deadline**: All sends complete by June 30, 2026. The July 1 California messaging infrastructure window is the outer limit.

**DO NOT send**: Friday afternoon, Monday morning, or the week of June 23-27 (pre-July 4 holiday).

---

## Contact Verification Checklist

Before sending, verify these contacts are current (10-15 minutes):

```
[ ] Common Cause California: commoncause.org/california — confirm email + current director name
[ ] LWV California: lwvc.org/about/staff — confirm current executive director + email
[ ] Clean Money Action Fund: cleanmoney.org — confirm organization is California-focused and email is current
[ ] Campaign Legal Center: campaignlegal.org/team — Adav Noti is listed as policy director (verify still current)
[ ] Issue One: issueone.org/contact — verify current executive director + email
```

Record verified contacts in `domain-51-send-log.md` before sending.

---

## Field Fill Summary

Each email requires two fills:
1. `[YOUR_NAME]` — your full name
2. `[YOUR_CONTACT_INFO]` — email and/or phone; optional organization affiliation

5 emails × 2 fields = 10 total field fills. No Gist URL replacement needed — all templates have the URL pre-filled.

---

*Templates created June 2, 2026. Gist URL live: https://gist.github.com/esca8peArtist/6dce895c5192e6a3ba2abfed40733372. Hard send deadline: July 1, 2026.*
