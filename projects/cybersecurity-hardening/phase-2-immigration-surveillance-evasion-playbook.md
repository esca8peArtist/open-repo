...
- Thomson Reuters CLEAR: ICE's $22.8 million LEIDS-5 contract ran through May 31, 2026. *(June 2026 update: The LEIDS-5 contract expired May 31, 2026. As of June 6, 2026, no confirmed renewal has been announced for the ICE-specific LEIDS-5 vehicle. More than 200 Thomson Reuters employees signed a letter demanding non-renewal; union investors launched a shareholder campaign ahead of the June 10, 2026 shareholder vote. However, a separate DHS contract was renewed March 31, 2026, running through 2029, providing continued access to CLEAR data through alternative contract vehicles. Thomson Reuters maintains multiple DHS/ICE contract vehicles estimated at ~$60M total. CLEAR opt-out remains a recommended action — removing your records from CLEAR at source protects you regardless of which specific contract vehicle provides access.)* CLEAR aggregates driver's license data, voter registrations, marriage records, property records, and commercial location data.
...
**Note on Geofence Warrant Constitutionality** *(June 27, 2026)*: The Supreme Court heard oral arguments in *Chatrie v. United States* on April 27, 2026, regarding the constitutional validity of geofence warrants, with a ruling expected summer 2026. That case addresses law enforcement acquisition of location data from telecommunications carriers (like Google) via warrant. The case does not directly affect Penlink's operational posture: ICE's legal position rests on the claim that Penlink data is commercially purchased rather than compelled from carriers, and therefore does not require a warrant under ICE's analysis. The *Chatrie* ruling may constrain law enforcement's ability to obtain location data from carriers via geofence warrants going forward, but does not retroactively invalidate ICE's Penlink subscription or change its current access to commercially-aggregated location data. Continue to treat Penlink as an active threat regardless of the *Chatrie* outcome.
...
**Version**: 1.1 (Q2 2026 patches applied June 6, 2026; Chatrie footnote added June 27, 2026)
**Created**: May 7, 2026
