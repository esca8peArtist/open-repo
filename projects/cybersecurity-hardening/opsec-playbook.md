...
## Part 11: IMSI Catcher Detection and Biometric Surveillance
...
### Facial Recognition & Aerial Surveillance

The facial recognition threat has expanded substantially beyond fixed checkpoints and border crossings. Three overlapping systems now constitute the operational threat for activists, organizers, and anyone attending public demonstrations.

**Clearview AI (confirmed ICE contract, $9.2M, September 2025)**: Clearview's database exceeds tens of billions of scraped internet images. ICE Homeland Security Investigations can query any face against this database with no judicial process. DHS removed its Biden-era facial recognition oversight policy from its website in February 2026 and published no replacement — meaning no internal accountability framework currently governs how agents use this capability. The Clearview consumer opt-out explicitly does not apply to federal law enforcement queries.

**Aerial surveillance — Skydio drones deployed at protests**: As of mid-2025, ICE and law enforcement agencies have deployed Skydio X10D drones at public demonstrations. The Skydio X10D is a defense-grade drone capable of detecting individuals from 7.5 miles and positively identifying them from 0.8 miles using optical and thermal imaging with AI-assisted tracking. In June 2025, CBP flew MQ-9 Predator drones over Los Angeles protests; the NYPD deployed multiple Skydio drones over New York demonstrations in October 2025; in November 2025, DHS imposed a civilian drone ban over Chicago during a demonstration. The November 2025 S.T.O.P. watchdog report confirmed that drone footage from NYPD operations was used as direct evidence to arrest protest participants. ICE spent $1.4 billion on surveillance contracts in September 2025 alone, its highest single-month figure on record. The FBI issued a procurement request in November 2025 for AI-powered drones with integrated facial recognition, license plate readers, and weapon detection — indicating aerial biometric capability is expanding across agencies, not contracting.

**Countermeasures for fixed and aerial facial recognition**:

- *Physical countermeasures*: A medical-grade mask (N95 or FFP2) covering the nose and mouth disrupts the lower facial geometry that most recognition algorithms require. A hat with a full brim — not a baseball cap — reduces overhead and oblique-angle image acquisition by aerial platforms. Sunglasses with wraparound coverage defeat periorbital feature extraction. These measures are additive: each one degrades matching accuracy; all three together substantially complicate automated identification against current systems. They are most effective against real-time matching by mobile agents and minimally-effective against high-resolution drone footage at close range, where thermal and optical systems can sometimes compensate.
- *Behavioral countermeasures*: Aerial surveillance is most valuable for retrospective identification — reviewing footage after an event to identify participants. The countermeasure is reducing the data available for retrospective review: avoid being photographed in identifiable clothing (distinctive logos, colors, accessories) that allow analysts to track a single person across multiple camera angles or across events. Vary appearance between events if you attend multiple actions.
- *Pattern of life countermeasures*: Aerial drone surveillance is frequently combined with ALPR networks and Palantir ELITE's address confidence scoring to extend identifications beyond the event itself — a partial facial match at a protest can be correlated against vehicle records (your car in a nearby parking garage) or ALPR records showing your car's travel pattern. The behavioral randomization described in Part 2.3 degrades this correlation.
- *Legal status*: No federal law currently requires a warrant before law enforcement uses facial recognition in public spaces. Several states and cities have enacted local restrictions, but federal agencies — including ICE and CBP — are not subject to those restrictions. There is no consumer opt-out for Clearview AI queries by federal law enforcement.

Sources: [Biometric Update: ICE awards Clearview AI $9.2M contract](https://www.biometricupdate.com/202509/ice-awards-clearview-ai-9-2m-facial-recognition-contract), [DroneXL: ICE $85B surveillance machine includes Skydio drones for protest monitoring](https://dronexl.co/2026/02/02/ices-surveillance-skydio-drones/), [The Intercept: FBI AI surveillance drones with facial recognition](https://theintercept.com/2025/11/21/fbi-ai-surveillance-drones-facial-recognition/), [TechPolicy.Press: How ICE will spy on protesters](https://www.techpolicy.press/how-ice-will-spy-on-protesters-and-how-you-can-protect-your-privacy/)

---

### Mobile Fortify — Handheld Field Biometric Identification

ICE deployed Mobile Fortify in 2025 — a handheld smartphone app developed by NEC Corporation that allows agents to photograph an individual in the field and run contactless fingerprint and facial recognition scans against DHS biometric databases in real time. The primary database is the Automated Biometric Identification System (IDENT), which holds records on over 270 million individuals; biometric records captured by Mobile Fortify are retained for 15 years even when no match is returned. The app has been used more than 100,000 times since launch (per a January 2026 lawsuit filed by Illinois and Chicago). A post-SCOTUS development amplifies this threat: the Supreme Court's June 2025 order in SSA v. AFSCME allowed DOGE personnel to access SSA records including Social Security numbers, address history, employer records, and benefit payment data, and Palantir's cross-agency architecture now routes query results across SSA, IRS, DHS/ICE, and HHS datasets. This means a Mobile Fortify biometric hit in the field can now generate an enriched dossier that includes financial history, current address confidence scores from ELITE, and SSA-linked employment records — a capability that was not operationally connected before the SCOTUS ruling. Mobile Fortify changes the physical encounter threat geometry in a way the standard IMSI catcher model does not: biometric collection no longer requires a formal government processing facility. It can occur at a traffic stop, on a street corner, or at a protest perimeter — any location where an ICE agent is present, and ICE agents documented using Mobile Fortify at protests by pointing their phones at demonstrators' faces. Physical countermeasures described in the section above (N95 mask, full-brim hat, wraparound sunglasses) apply directly to Mobile Fortify encounters; these are not abstract precautions — they are the only available real-time mitigation since the scan is completed in seconds before any legal process could intervene. A documented accuracy problem with Mobile Fortify matters for threat modeling: in at least one reported case, the same individual scanned twice in the same encounter was returned two different (both incorrect) names, meaning false-positive identification shifts the burden of proof onto the person who is wrongly matched. The Illinois and Chicago lawsuit alleges that this practice violates the Illinois Biometric Information Privacy Act and exceeds ICE's statutory authority — but litigation is slow and enforcement is not paused during the suit. If you are approached and believe you may have been incorrectly identified by a field device, do not confirm or deny identity without legal counsel — the match is not legally conclusive and the system has documented error rates. Avoid predictable movement patterns (daily commute at fixed times, habitual gathering locations) that allow pattern-of-life analysis to predict where you will be; Mobile Fortify's value to investigators increases when combined with Palantir's ELITE address confidence scoring and the newly-fused DOGE/SSA data layer, so the same behavioral randomization that degrades ELITE scoring (Part 2.3) also degrades the predictive value of any Mobile Fortify encounter data.

Sources: [Wikipedia: Mobile Fortify](https://en.wikipedia.org/wiki/Mobile_Fortify), [Biometric Update: ICE Mobile Fortify powered by NEC](https://www.biometricupdate.com/202601/ice-facial-recognition-app-mobile-fortify-powered-by-nec), [NPR: ICE surveillance confrontation Mobile Fortify](https://www.npr.org/2026/03/04/nx-s1-5717031/ice-dhs-immigrants-surveillance-confrontation-deportation-mobile-fortify), [EFF: Rights organizations demand halt to Mobile Fortify](https://www.eff.org/deeplinks/2025/11/rights-organizations-demand-halt-mobile-fortify-ices-handheld-face-recognition), [CNBC: Supreme Court gives DOGE access to Social Security data](https://www.cnbc.com/2025/06/09/supreme-court-gives-doge-access-to-personal-social-security-data.html), [State of Surveillance: ICE Mobile Fortify biometric surveillance](https://stateofsurveillance.org/articles/surveillance/ice-mobile-fortify-biometric-surveillance-app/)
