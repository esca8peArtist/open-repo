...
## 8. Cannibalization and Cross-Guide Substitution Framework
...
*Cross-references: `customer-cohort-analysis-framework.md` (full cohort profiles and messaging), `etsy-ga4-event-tracking.md` (GA4 event schema), `customer-retention-tracker.csv` (monthly cohort rollup template), `analytics/cohort-analysis-template.sql` (SQL queries), `analytics/monthly-metrics-checklist.md` (monthly operator runbook).*
